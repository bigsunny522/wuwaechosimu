      ...
      >
        ...
        {!unlocked ? (
          <div className="text-center py-6">
            ...
            <div className="text-sm font-medium text-[#222222] mb-1">{T.bulkLocked}</div>
            <div className="text-sm text-[#707070] mb-6">{T.bulkLockedSub}</div>
            {watchingAd ? (
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-[500px] text-sm font-medium text-[#f7f7f7] bg-[#222222] transition-opacity hover:opacity-80"
              >
                {T.bulkUnlockBtn}
              </button>
            )}
